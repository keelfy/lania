...
const gallery = [
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-19_11.15.29.png',
    alt: 'Dragons (Lania III)',
    name: 'LANIA III',
    authors: ['Asdqqq', 'Foxizans'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-19_11.07.36.png',
    alt: 'Dark Church (Lania III)',
    name: 'LANIA III',
    authors: ['keelfy'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-19_11.14.56.png',
    alt: 'Flying Base (Lania III)',
    name: 'LANIA III',
    authors: ['Quermercus_'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-04-17_16.59.00_2.png',
    alt: 'Spawn (Lania III)',
    name: 'LANIA III',
    authors: ['frogot123', 'keelfy'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-29_21.23.23.png',
    alt: 'Overgrown Base (Lania II)',
    name: 'LANIA II',
    authors: ['keelfy', 'loonatya'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-04-12_17.17.37.png',
    alt: 'The End (Lania III)',
    name: 'LANIA III',
    authors: [],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/IMG_9256.JPG',
    alt: 'Snowmans (Lania III)',
    name: 'LANIA III',
    authors: [],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-29_21.30.10.png',
    alt: 'Farms (Lania I)',
    name: 'LANIA I',
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-29_21.25.11.png',
    alt: 'keelfy base (Lania I)',
    name: 'LANIA I',
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-04-09_22.33.44.png',
    alt: 'Boats attack (Lania III)',
    name: 'LANIA III',
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-29_21.26.21.png',
    alt: 'Angel (Lania I)',
    name: 'LANIA I',
    authors: ['BiruSan'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/lania-spinoff-1-dragon.png',
    alt: 'Dragon (Lania Spinoff I)',
    name: 'LANIA SPINOFF I',
    authors: ['Asdqqq'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-29_21.23.37.png',
    alt: 'Overgrown Base 2 (Lania II)',
    name: 'LANIA II',
    authors: ['loonatya', 'keelfy'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/IMG_9260.JPG',
    alt: 'Foxizans humor (Lania III)',
    name: 'LANIA III',
    authors: ['Foxizans', 'frogot123', 'Asdqqq'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-19_11.26.57.png',
    alt: 'Market (Lania III)',
    name: 'LANIA III',
    authors: ['loonatya'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/2025-08-29_21.28.21.png',
    alt: 'Cherry Blossom Base (Lania I)',
    name: 'LANIA I',
    authors: ['loonatya', 'Eugene'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/KefLand3Season.jpg',
    alt: 'Bloody Night (Lania III)',
    name: 'LANIA III',
    authors: ['frogot123'],
  },
  {
    src: 's3://lania-web-134312503254-eu-central-1-an/lania-spinoff-1-aero.png',
